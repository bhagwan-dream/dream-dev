...
class BetPlaceController extends \common\controllers\aController  // \yii\rest\Controller
{
...
//                        }else{ $profitLimitData = []; }
                        ...
                        $checkBetMaxProfitLimit = $this->checkBetMaxProfitLimit($uid,$model);
            ...
            if( $r_data['session_type'] == 'fancy2' || $r_data['session_type'] == 'fancy'
                || $r_data['session_type'] == 'lottery' || $r_data['session_type'] == 'jackpot' ){
...
//                }
    ...
    public function checkUnBlockList($uId)
    {
        ...
        $listArr = (new \yii\db\Query())
            ...
            ->where(['user_id'=>$pId,'market_type' => 'all' ])->createCommand(Yii::$app->db2)->queryAll();
    ...
    public function checkUnBlockSportList($uId)
    {
        ...
        $listArr = (new \yii\db\Query())
            ...
            ->where(['user_id'=>$pId ])->createCommand(Yii::$app->db2)->queryAll();
...
//    }
    ...
    //checkBetMinMaxLimit
    public function checkBetMaxProfitLimit($uid,$model){
