...
class AuthController extends \common\controllers\cController
{
                                    ...
                                    if( $user->save(['is_login']) ){
                                        ...
                                        $response =  [
                                            ...
                                            "data" => [
                                                ...
                                                "role"   => $user->role,
                                                "bet_options" => $this->getBetOptions( $user->id ),
    ...
    private function getBetOptions( $uid ){
    ...
    private function getAllowedResourcesOLD( $type ){
        $resources = [ ""  , "index" , "404" ];
