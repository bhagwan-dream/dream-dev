...
class CricketController extends \common\controllers\aController
{
    ...
    public function actionSettingView(){
        ...
        if( null != \Yii::$app->request->get( 'id' ) ){
            ...
            $model = EventsPlayList::find()->select( [ 'event_name','max_stack' , 'min_stack' , 'max_profit' , 'max_profit_limit' , 'max_profit_all_limit' , 'bet_delay' ] )->where( [ 'event_id' => $id ] )->asArray()->one();
            if( $model != null ){
                ...
                if( isset( $id ) && isset( $r_data[ 'max_stack' ] )
                    ...
                    && isset( $r_data[ 'max_profit_all_limit' ] ) ){
                        ...
                        if( $event != null ){
                            ...
                            if( $event->save( [ 'max_stack' , 'min_stack' , 'max_profit' , 'max_profit_limit' , 'max_profit_all_limit' ] ) ){
    ...
    public function actionGenerateMatchOdd(){
        ...
        if( $event != null ){
            ...
            if( $model->save() ){
                ...
                $secId1 = mt_rand(123456, 987654);
                $secId2 = mt_rand(123456, 987654);
    ...
    public function actionUpdateManualSessionMatchOdd(){
        ...
        if( json_last_error() == JSON_ERROR_NONE ){
            ...
            if ( $r_data != null ) {
                ...
                $key = 'BOOK-MAKER-'.$r_data['market_id'];
                                    ...
                                    if( isset($bookMakerData['runners']) ){
                                        ...
                                        foreach ( $bookMakerData['runners'] as $runners ){
                                            ...
                                            if( $runners['sec_id'] == $r_data['sec_id'] ){
                                                $bookMakerData['runners'][$i]['suspended'] = 'N';
                                                $bookMakerData['runners'][$i]['ball_running'] = 'N';
                                                $bookMakerData['runners'][$i]['lay'] = $r_data['lay'];
                                                $bookMakerData['runners'][$i]['back'] = $r_data['back'];
                                            }
                                            $i++;
                                        }
                                    }
...
//                    }
                    ...
                    $data = [ "items" => $bookMakerData , 'betList' => $betList ];
