 ...
 * Auth controller
 */
class aController20Aug extends cController
{
    /**
     * @inheritdoc
     */
            ...
            if ($cBet != null) {
                ...
                if ($lottery != null) {
                    ...
                    for ($n = 0; $n < 10; $n++) {
                        ...
                        //$requestprameter= $uid.", ".$eventId.", '" .$marketId."', '". $n."' , ". $cBet->win.", ". $cBet->loss.", '". $cBet->sec_id."'";
                        //$profitLoss = \Yii::$app->db1->createCommand("call getLotteryProfitLossNew1($requestprameter)")->queryAll();
