 ...
 * Auth controller
 */
class aController25Jul extends cController
{
    /**
     * @inheritdoc
     */
        ...
        if ($user != null) {
                ...
                foreach ($marketList as $market) {
                    ...
                    if ($event != null) {
                        ...
                        if ($runnersData != null) {
                            $balExpose = $balPlus = [];
                            foreach ($runnersData as $runners) {
                                $profitLoss = $this->getProfitLossMatchOddsNewAll1($marketId, $eventId, $runners->selection_id, 'match_odd');
                                if ($profitLoss < 0) {
                                    $balExpose[] = $profitLoss;
                                } else {
                                    $balPlus[] = $profitLoss;
                        ...
                        if ($balExpose != null) {
                            ...
                            //echo $marketId . '=' . min($balExpose) . '<br>';
                        }
            ...
            if ($eventNew != null) {
                ...
                if ($runnersData != null) {
                    $balExpose = $balPlus = [];
                    foreach ($runnersData as $runners) {
                        $profitLoss = $this->getProfitLossMatchOddsNew1($marketId, $eventId, $runners->selection_id, 'match_odd', $cBet);
                        if ($profitLoss < 0) {
                            $balExpose[] = $profitLoss;
                        } else {
                            $balPlus[] = $profitLoss;
                ...
                foreach ($marketList2 as $market) {
                    ...
                    if ($event != null) {
                        ...
                        if ($runnersData != null) {
                            $balExpose = $balPlus = [];
                            foreach ($runnersData as $runners) {
                                $profitLoss = $this->getProfitLossMatchOddsNewAll1($marketId, $eventId, $runners->sec_id, 'match_odd2');
                                if ($profitLoss < 0) {
                                    $balExpose[] = $profitLoss;
                                } else {
                                    $balPlus[] = $profitLoss;
            ...
            if ($eventNew2 != null) {
                ...
                if ($runnersData != null) {
                    $balExpose = $balPlus = [];
                    foreach ($runnersData as $runners) {
                        $profitLoss = $this->getProfitLossMatchOddsNew1($marketId, $eventId, $runners->sec_id, 'match_odd2', $cBet);
                        if ($profitLoss < 0) {
                            $balExpose[] = $profitLoss;
                        } else {
                            $balPlus[] = $profitLoss;
            ...
            if ($marketList3 != null) {
                ...
                foreach ($marketList3 as $market) {
                    ...
                    if ($event != null) {
                        $eventId = $event->event_id;
                        $profitLossData = $this->getProfitLossFancyOnZeroNewAll1($marketId, 'fancy');
...
//                            $eventProfitLimit[$eventId][] = max($profitLossData);
//                            $sportProfitLimit[] = max($profitLossData);
//                        }
            ...
            if ($cBet != null && $cBet->session_type == 'fancy') {
                ...
                if ($eventNew2 != null) {
                    $eventId = $eventNew2->event_id;
                    $profitLossData = $this->getProfitLossFancyOnZeroNew1($marketId, 'fancy', $cBet);
...
//                    }
            ...
            if ($marketList4 != null) {
                ...
                foreach ($marketList4 as $market) {
                    ...
                    if ($event != null) {
                        $eventId = $event->event_id;
                        $profitLossData = $this->getProfitLossFancyOnZeroNewAll1($marketId, 'fancy2');
            ...
            if ($cBet != null && $cBet->session_type == 'fancy2') {
                ...
                if ($eventNew != null) {
                    $eventId = $eventNew->event_id;
                    $profitLossData = $this->getProfitLossFancyOnZeroNew1($marketId, 'fancy2', $cBet);
            ...
            if ($marketList5 != null) {
                ...
                foreach ($marketList5 as $market) {
                    ...
                    if ($lottery != null) {
                        ...
                        $balExpose = $balPlus = [];
                        for ($n = 0; $n < 10; $n++) {
                            $profitLoss = $this->getLotteryProfitLossNewAll1($eventId, $marketId, $n);
                            if ($profitLoss < 0) {
                                $balExpose[] = $profitLoss;
                            } else {
                                $balPlus[] = $profitLoss;
    ...
    public function getProfitLossMatchOddsNewAll1($marketId, $eventId, $selId, $sessionType)
    {
    ...
    public function getProfitLossMatchOddsNew1($marketId, $eventId, $selId, $sessionType, $cBet)
    {
        $userId = \Yii::$app->user->id;
        $total = 0;
    ...
    public function getProfitLossFancyOnZeroNewAll1($marketId, $sessionType)
    {
        $userId = \Yii::$app->user->id;
...
//	    }
        ...
        if ($betList != null) {
            ...
            for ($i = $min; $i <= $max; $i++) {
                ...
                if (!isset($betList1[0]['winVal'])) {
                    ...
                    $winVal1 = $betList1[0]['winVal'];
                }
                if (!isset($betList2[0]['winVal'])) {
                    $winVal2 = 0;
                } else {
                    $winVal2 = $betList2[0]['winVal'];
                }
                if (!isset($betList3[0]['lossVal'])) {
                    $lossVal1 = 0;
                } else {
                    $lossVal1 = $betList3[0]['lossVal'];
                }
                if (!isset($betList4[0]['lossVal'])) {
                    $lossVal2 = 0;
                } else {
                    $lossVal2 = $betList4[0]['lossVal'];
                }
    ...
    public function getProfitLossFancyOnZeroNew1($marketId, $sessionType, $cBet)
    {
        $userId = \Yii::$app->user->id;
...
//                if ($marketId == '1.1559458055-MFY')
    ...
    public function getLotteryProfitLossNewAll1($eventId, $marketId, $selectionId)
    {
        $total = 0;
        $userId = \Yii::$app->user->id;
        ...
        if ($betWinList == null) {
            ...
            $totalWin = $betWinList[0]['totalWin'];
        }

        if ($betLossList == null) {
            $totalLoss = 0;
        } else {
            $totalLoss = (-1) * $betLossList[0]['totalLoss'];
        }
    ...
    public function getLotteryProfitLossNew1($eventId, $marketId, $selectionId, $cBet)
    {
        $total = 0;
        $userId = \Yii::$app->user->id;
    ...
    public function getProfitLimitMatchOdds($marketId, $eventId, $selId, $sessionType, $cBet)
    {
        $userId = \Yii::$app->user->id;
        $total = 0;
    ...
    //AllUserForAdmin
    public function getAllUserForAdminUNUSED($uid)
    {
        $userList = [];
        ...
        if ($smdata != null) {
            ...
            foreach ($smdata as $sm) {
                ...
                $userList[] = $sm->id;
                // get all master
                $sm2data = User::find()->select(['id', 'role'])->where(['parent_id' => (int)$sm->id, 'role' => 2])->all();
                if ($sm2data != null) {

                    foreach ($sm2data as $sm2) {
                        $userList[] = (int)$sm2->id;
                        // get all master
                        $m1data = User::find()->select(['id', 'role'])->where(['parent_id' => (int)$sm2->id, 'role' => 3])->all();
                        if ($m1data != null) {
    ...
    public function getAllClientForAdmin($uid)
    {
        ...
        if ($smdata != null) {
            ...
            foreach ($smdata as $sm) {
                ...
                $sm2data = User::find()->select(['id', 'role'])
                    ->where(['parent_id' => (int)$sm['id'], 'role' => 2])->asArray()->all();
                if ($sm2data != null) {

                    foreach ($sm2data as $sm2) {
                        // get all master
                        $m1data = User::find()->select(['id', 'role'])
                            ->where(['parent_id' => (int)$sm2['id'], 'role' => 3])->asArray()->all();
                        if ($m1data != null) {
                            foreach ($m1data as $m1) {
                                // get all master
        ...
        // get all client
        $cdata = User::find()->select(['id'])
            ->where(['parent_id' => (int)$uid, 'role' => 4])->asArray()->all();
        if ($cdata != null) {
            foreach ($cdata as $c) {
                $client[] = (int)$c['id'];
            }
