...
class aController extends cController
{
    ...
    public function checkMaxProfitLimit($cBet, $profitLimitData)
    {
        ...
        if ($cBet != null) {
            $profitMatchOddVal = $profitMatchOdd2Val = $profitFancyVal = $profitFancy2Val = $profitJackpotVal =$profitLotteryVal = 0;
            $maxProfitLimitMatchOdd = $maxProfitLimitMatchOdd2 = $maxProfitLimitFancy = $maxProfitLimitFancy2 =$maxProfitLimitJackpot= $maxProfitLimitLottery = 100000;
            ...
            if ($event != null) {
               ...
               $event = (new \yii\db\Query())
                ->select(['max_profit_limit'])
                ->from('cricket_jackpot_setting')->where(['event_id' => $eventId])
                ->createCommand(Yii::$app->db2)->queryOne();

            if ($event != null) {

                $maxProfitLimitJackpot = $event['max_profit_limit'];
            ...
            } else if ($cBet->session_type == 'jackpot') {

                if ($profitJackpotVal > $maxProfitLimitJackpot) {
                    $isTrue = false;
                } else {
                    $isTrue = true;
                }
    ...
    //checkMaxProfitLimit
    public function checkMaxProfitLimitNew($cBet)
    {

        if ($cBet != null) {
            $newProfitVat = $profitLimitEvent = $profitMatchOddVal = $profitMatchOdd2Val = $profitFancyVal = $profitFancy2Val = $profitJackpotVal = $profitLotteryVal = 0;
            ...
            //Market Profit Data
            if( $cBet->session_type == 'jackpot' ){
                $where = [ 'user_id' => $uid , 'status' => 1 , 'market_id' => $eventId.'-JKPT' , 'event_id' => $eventId ];
            }else{
            ...
            if ( $cBet->session_type == 'match_odd' ) {
                ...
                if ( $profitLimitData != null) {
                    if ( isset($profitLimitData['profitVal']) && $profitLimitData['profitVal'] != null ) {
                        $profitMatchOddVal = $profitLimitData['profitVal'];
                        $newProfitVat = (int)$profitLimitData['profitVal']+$betWinVal;
                    }
                }
                ...
                if ($profitMatchOddVal > $maxProfitLimitMatchOdd) {
                    ...
                    \Yii::$app->db->createCommand()
                        ->update('user_event_expose', [ 'profit' => $newProfitVat ], ['user_id' => $uid ,'market_id' => $marketId,'event_id' => $eventId])
                        ->execute();
                }

                $type = 'market is '.$maxProfitLimitMatchOdd;

            }

            //MatchOdd2
            if ( $cBet->session_type == 'match_odd2' ) {

                if ( $profitLimitData != null) {
                    if ( isset($profitLimitData['profitVal']) && $profitLimitData['profitVal'] != null ) {
                        $profitMatchOdd2Val = $profitLimitData['profitVal'];
                        $newProfitVat = (int)$profitLimitData['profitVal']+$betWinVal;
                    }
                }
                ...
                $type = 'market is '.$maxProfitLimitMatchOdd2;

            }

            //Fancy
            if ( $cBet->session_type == 'fancy' ) {

                if ( $profitLimitData != null) {
                    if ( isset($profitLimitData['profitVal']) && $profitLimitData['profitVal'] != null ) {
                        $profitFancyVal = $profitLimitData['profitVal'];
                        $newProfitVat = (int)$profitLimitData['profitVal']+$betWinVal;
                    }
                }
            ...
            //Fancy2
            if ( $cBet->session_type == 'fancy2' ) {

                if ( $profitLimitData != null) {
                    if ( isset($profitLimitData['profitVal']) && $profitLimitData['profitVal'] != null ) {
                        $profitFancy2Val = $profitLimitData['profitVal'];
                        $newProfitVat = (int)$profitLimitData['profitVal']+$betWinVal;
                    }
                }
                ...
                $type = 'market is '.$maxProfitLimitFancy2;

            }

            //Lottery
            if ( $cBet->session_type == 'lottery' ) {

                if ( $profitLimitData != null) {
                    if ( isset($profitLimitData['profitVal']) && $profitLimitData['profitVal'] != null ) {
                        $profitLotteryVal = $profitLimitData['profitVal'];
                        $newProfitVat = (int)$profitLimitData['profitVal']+$betWinVal;
                    }
                }
                ...
                $type = 'market is '.$maxProfitLimitLottery;
            }
            ...
            if ( $cBet->session_type == 'jackpot' ) {
                ...
                if ( $profitLimitData != null) {
                    if ( isset($profitLimitData['profitVal']) && $profitLimitData['profitVal'] != null ) {
                        $profitJackpotVal = $profitLimitData['profitVal'];
                        $newProfitVat = (int)$profitLimitData['profitVal']+$betWinVal;
                    }
                }
                ...
                if ($profitJackpotVal > $maxProfitLimitJackpot) {
                    ...
                    \Yii::$app->db->createCommand()
                        ->update('user_event_expose', ['profit' => $newProfitVat ], ['user_id' => $uid ,'event_id' => $eventId])
                        ->execute();

                }

                $type = 'market is '.$maxProfitLimitJackpot;
            ...
            if ( $isTrue == true ) {
                ...
                //Event Profit Data
                $where = [ 'user_id' => $uid , 'event_id' => $eventId , 'status' => 1 ];
                ...
                if ( $profitLimitData != null) {
                    if (isset($profitLimitData['profitVal']) && $profitLimitData['profitVal'] != null ) {
                        $profitLimitEvent = $profitLimitData['profitVal'];
                    }
                }
                ...
                $type = 'event is '.$maxProfitLimitEvent;
...
//                }
    ...
    public function checkMaxProfitLimitNewBet($cBet)
    {
        ...
        if ($cBet != null) {
            $currentProfitVat = $newProfitVat = $profitLimitEvent = $profitMatchOddVal = $profitMatchOdd2Val = $profitFancyVal = $profitFancy2Val = $profitJackpotVal = $profitLotteryVal = 0;
            $maxProfitLimitMatchOdd = $maxProfitLimitMatchOdd2 = $maxProfitLimitFancy = $maxProfitLimitFancy2 = $maxProfitLimitJackpot = $maxProfitLimitLottery = $maxProfitLimitEvent = 100000;
            ...
            if ( $cBet->session_type == 'match_odd2' ) {
                ...
                if ( $profitLimitData != null) {
                    if ( isset($profitLimitData['profitVal']) && $profitLimitData['profitVal'] != null ) {
                        $currentProfitVat = (int)$profitLimitData['profitVal'];
                        $newProfitVat = $profitMatchOdd2Val = (int)$profitLimitData['profitVal']+$betWinVal;
                    }
                }
            ...
            if ( $cBet->session_type == 'fancy' ) {
                ...
                if ( $profitLimitData != null) {
                    if ( isset($profitLimitData['profitVal']) && $profitLimitData['profitVal'] != null ) {
                        $currentProfitVat = (int)$profitLimitData['profitVal'];
                        $newProfitVat = $profitFancyVal = (int)$profitLimitData['profitVal']+$betWinVal;
                    }
                }
            ...
            if ( $cBet->session_type == 'fancy2' ) {
                ...
                if ( $profitLimitData != null) {
                    if ( isset($profitLimitData['profitVal']) && $profitLimitData['profitVal'] != null ) {
                        $currentProfitVat = (int)$profitLimitData['profitVal'];
                        $newProfitVat = $profitFancy2Val = (int)$profitLimitData['profitVal']+$betWinVal;
                    }
                }
            ...
            if ( $cBet->session_type == 'lottery' ) {
                ...
                if ( $profitLimitData != null) {
                    if ( isset($profitLimitData['profitVal']) && $profitLimitData['profitVal'] != null ) {
                        $currentProfitVat = (int)$profitLimitData['profitVal'];
                        $newProfitVat = $profitLotteryVal = (int)$profitLimitData['profitVal']+$betWinVal;
                    }
                }
            ...
            if ( $cBet->session_type == 'jackpot' ) {
                ...
                if ( $profitLimitData != null) {
                    if ( isset($profitLimitData['profitVal']) && $profitLimitData['profitVal'] != null ) {
                        $currentProfitVat = (int)$profitLimitData['profitVal'];
                        $newProfitVat = $profitJackpotVal = (int)$profitLimitData['profitVal']+$betWinVal;
                    }
                }
            ...
            if ( $isTrue == true ) {
                ...
                if ( $profitLimitData != null) {
                    if (isset($profitLimitData['profitVal']) && $profitLimitData['profitVal'] != null ) {
                        ...
                        //echo 'Current event PL => '.$profitLimitEvent.' Current market PL => ';
                        //echo $currentProfitVat.' New market PL => ';
                        //echo $newProfitVat.' New event PL => ';
                        $profitLimitEvent = $profitLimitEvent-$currentProfitVat+$newProfitVat;
                        //echo $profitLimitEvent.' Profit Limit Event => ';
                    }
                }
...
//                }
            ...
            if ($cBet != null) {
             ...
             $marketList6 = (new \yii\db\Query())
                ...
                ->andWhere(['!=', 'event_id', $cBet->event_id])
                ->groupBy(['event_id'])->createCommand(Yii::$app->db2)->queryAll();

            if ($marketList6 != null) {

                $jackpotData = (new \yii\db\Query())
                    ->select(['market_id'])->from('cricket_jackpot')
                    ->where(['event_id' => $marketList6 , 'status' => 1 , 'game_over' => 'NO' ])
                    ->groupBy(['market_id'])->createCommand(Yii::$app->db2)->queryAll();

                //foreach ( $jackpotData as $jackpot ){
                    $where = [ 'user_id' => $uid , 'status' => 1 , 'market_id' => $jackpotData ];
                    $userExpose = (new \yii\db\Query())
                        ->select(['sum(expose) as exposeVal'])->from('user_event_expose')->where($where)
                        ->createCommand(Yii::$app->db2)->queryOne();
                    if( $userExpose != null ){
            ...
            if ($cBet != null) {
                ...
                if ($jackpot != null) {
                    $eventId = $jackpot['event_id'];
                    $balExpose = $balPlus = [];

                    $jackpotPlayers = (new \yii\db\Query())
                        ->select(['market_id'])
                        ->from('cricket_jackpot')
                        ->where(['event_id' => $eventId])->createCommand(Yii::$app->db2)->queryAll();

                    foreach ($jackpotPlayers as $key => $jackpot_players) {

                        $profitLoss = $this->getJackpotProfitLossNew1($uid,$eventId, $jackpot_players['market_id'], $cBet);
    ...
    //getBalanceVal
    public function getBalanceRefreshAfterBet($uid,$cBet)
    {
        $user = (new \yii\db\Query())
            ->select(['balance', 'expose_balance', 'profit_loss_balance'])
            ->from('user')->where(['id' => $uid])
        ...
        if ($user != null) {
            ...
            if ($marketList6 != null) {
                ...
                $where = [ 'user_id' => $uid , 'status' => 1 , 'market_id' => $marketList6 ];
                $userExpose = (new \yii\db\Query())
                    ->select(['sum(expose) as exposeVal'])->from('user_event_expose')->where($where)
                    ->createCommand(Yii::$app->db2)->queryAll();
                if( $userExpose != null ){
...
//            }
    ...
    public function getProfitLossMatchOddsNew1($userId,$marketId, $eventId, $selId, $sessionType, $cBet)
    {
        ...
        if (null != $userId && $marketId != null && $eventId != null && $selId != null) {
            ...
            /*$requestprameter=$userId.", ".$eventId.", '" .$marketId."', '".$selId."', '".$sessionType."'";
            $getProfitLossMatchOddsNew = \Yii::$app->db1->createCommand("call getProfitLossMatchOddsNew1($requestprameter)")->queryAll();

            //echo '<pre>';print_r($getProfitLossMatchOddsNew);die;
            $totalLoss=$getProfitLossMatchOddsNew[0]['totalLoss'];
            $totalWin=$getProfitLossMatchOddsNew[0]['totalWin'];*/
...
//                    ->asArray()->all();
                ...
                $betList1 = $query->select('SUM( win ) as winVal')
...
//                    ->asArray()->all();
                ...
                $betList2 = $query->select('SUM( win ) as winVal')
                    ->from('place_bet')->where($where)->andWhere(['<=', 'price', (int)$i])
                    ->createCommand(Yii::$app->db2)->queryOne();
...
//                    ->asArray()->all();
                ...
                $betList3 = $query->select('SUM( loss ) as lossVal')
                    ->from('place_bet')->where($where)->andWhere(['>', 'price', (int)$i])
                    ->createCommand(Yii::$app->db2)->queryOne();
...
//                    ->asArray()->all();
                ...
                $betList4 = $query->select('SUM( loss ) as lossVal')
                    ->from('place_bet')->where($where)->andWhere(['<=', 'price', (int)$i])
                    ->createCommand(Yii::$app->db2)->queryOne();
...
//                if ($marketId == '1.1559458055-MFY')
            ...
            //set on this function store peocedure
//            $requestprameter = $userId.",'" .$marketId."', ". $min." , ". $max." , ". $cBet->win.", ". $cBet->loss.",".$cBet->price." ,'". $cBet->bet_type."','".$sessionType."'";
//            $results = \Yii::$app->db1->createCommand("call getProfitLossFancyOnZeroNew1($requestprameter)")->queryAll();
//            $result = explode(',', $results[0]['str']);
    ...
    public function getJackpotProfitLossNew1($userId,$eventId, $marketId, $cBet)
    {
        $total = 0;
        //$userId = \Yii::$app->user->id;
        $where = ['bet_status' => 'Pending', 'status' => 1,'session_type' => 'jackpot', 'user_id' => $userId, 'event_id' => $eventId];
        // IF RUNNER WIN
        $betWinList = (new \yii\db\Query())
            ->select('SUM(win) as totalWin')
    ...
    public function getAllUserForSuperMaster($uid)
    {
        ...
        if ($smdata != null) {
            foreach ($smdata as $sm) {
                ...
                $m1data = User::find()->select(['id', 'role'])->where(['parent_id' => (int)$sm->id, 'role' => 2])->all();
                if ($m1data != null) {
                    foreach ($m1data as $m1) {
                        $userList[] = (int)$m1->id;
                        // get all master
    ...
    public function getProfitLossFancyOnZeroNEWBHAGWAN($userId,$marketId,$sessionType)
    {
        //$userId = \Yii::$app->user->id;
